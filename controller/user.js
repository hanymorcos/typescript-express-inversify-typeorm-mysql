...
var UserController = (function () {
    ...
    UserController.prototype.getUsers = function (response, next) {
    ...
    UserController.prototype.getUser = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getUser(request.params.id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    UserController.prototype.newUser = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.newUser(request.body)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    UserController.prototype.updateUser = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.updateUser(request.params.name, request.params.email)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
